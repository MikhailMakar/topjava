...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2017, Month.MAY, 30, 10, 0), "Завтрак", 450, 2),
            new Meal(LocalDateTime.of(2017, Month.MAY, 30, 13, 0), "Обед", 915, 2),
            new Meal(LocalDateTime.of(2017, Month.MAY, 30, 20, 0), "Ужин", 500, 2),
            new Meal(LocalDateTime.of(2017, Month.MAY, 31, 10, 0), "Завтрак", 1100, 2),
            new Meal(LocalDateTime.of(2017, Month.MAY, 31, 13, 0), "Обед", 620, 2),
            new Meal(LocalDateTime.of(2017, Month.MAY, 31, 20, 0), "Ужин", 490, 2)
    );
